...
<section class="hero"><div class="container hero-grid">
  ...
  <div class="hero-visual"><div class="hero-visual-blue"></div><div class="hero-logo-card"><img src="assets/azure-pharm-logo.png" alt="Logo Azuré Pharm"><div class="hero-logo-caption">Votre partenaire de confiance.</div></div><div class="hero-side-label">SANTÉ <span>·</span> HYGIÈNE <span>·</span> CONFIANCE</div></div>
</div></section>
