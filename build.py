...
<body>
  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <a class="header-contact button button-inset" href="contact.html">Nous contacter <span aria-hidden="true">↗</span></a>
...
<section class="section mission-band"><div class="container mission-grid"><span class="eyebrow">NOTRE MISSION</span><h2>Contribuer à un environnement de soins plus sûr.</h2><p>Azuré Pharm s’engage à répondre aux besoins d’hygiène des patients et du personnel soignant avec une production locale et une attention constante à la qualité.</p><a class="button button-inset button-dark" href="entreprise.html">En savoir plus <span aria-hidden="true">↗</span></a></div></section>
<section class="section"><div class="container location-teaser"><div><span class="eyebrow">ANCRAGE LOCAL</span><h2>Produire en Algérie,<br>au plus près des besoins.</h2><p>Unité de production à Ouled Moussa. Siège social à Dely Brahim, Alger.</p><a class="button button-inset" href="entreprise.html#implantations">Notre entreprise <span aria-hidden="true">↗</span></a></div><div class="location-photo"><img src="assets/production-illustration.png" alt="Vue illustrative d’une ligne de production de produits d’hygiène"><span>Visuel d’illustration</span></div></div></section>
<section class="contact-strip"><div class="container contact-strip-inner"><div><span class="eyebrow">UN BESOIN, UNE QUESTION ?</span><h2>Échangeons sur vos besoins.</h2></div><a class="button button-inset button-strip" href="contact.html">Nous contacter <span aria-hidden="true">↗</span></a></div></section>
'''),
...
<section class="section page-intro"><div class="container"><div class="section-heading split-heading"><div><span class="eyebrow">DÉCOUVRIR LA GAMME</span><h2>Trois usages, une même exigence d’hygiène.</h2></div><p>Explorez la famille de produits qui correspond à votre besoin. Notre équipe peut vous renseigner sur les informations et documents disponibles pour chaque référence.</p></div><div class="jump-grid"><a href="#sols-surfaces"><span>01</span><strong>Sols & surfaces</strong><small>Entretien des espaces de soins ↗</small></a><a href="#surfaces-hautes"><span>02</span><strong>Surfaces hautes</strong><small>Zones de contact et mobilier ↗</small></a><a href="#instruments"><span>03</span><strong>Instruments</strong><small>Étape de pré-désinfection ↗</small></a></div></div></section>
<section class="section"><div class="container product-list">
<article class="product-row" id="sols-surfaces"><div class="product-row-number">01</div><div><span class="eyebrow">SOLS & SURFACES</span><h2>Détergents désinfectants sols et surfaces</h2><p>Une gamme destinée à l’entretien des sols et des surfaces dans les environnements de soins et les espaces collectifs.</p><a class="button button-inset" href="contact.html?produit=Sols%20et%20surfaces">Demander des informations ↗</a></div><figure class="product-row-art"><img src="assets/product-sols-surfaces.png" alt="Visuel illustratif du produit pour sols et surfaces"></figure></article>
<article class="product-row" id="surfaces-hautes"><div class="product-row-number">02</div><div><span class="eyebrow">SURFACES HAUTES</span><h2>Détergents désinfectants surfaces hautes</h2><p>Des solutions consacrées à l’entretien des surfaces hautes et des zones de contact dans les établissements de santé.</p><a class="button button-inset" href="contact.html?produit=Surfaces%20hautes">Demander des informations ↗</a></div><figure class="product-row-art"><img src="assets/product-surfaces-hautes.png" alt="Visuel illustratif du produit pour surfaces hautes"></figure></article>
<article class="product-row" id="instruments"><div class="product-row-number">03</div><div><span class="eyebrow">INSTRUMENTS</span><h2>Nettoyants pré-désinfectants des instruments</h2><p>Une famille de produits destinée à l’étape de pré-désinfection des instruments utilisés par les professionnels de santé.</p><a class="button button-inset" href="contact.html?produit=Instruments">Demander des informations ↗</a></div><figure class="product-row-art"><img src="assets/product-instruments.png" alt="Visuel illustratif du produit pour instruments"></figure></article>
</div></section><section class="section pale-section"><div class="container"><div class="section-heading split-heading"><div><span class="eyebrow">POUR LES PROFESSIONNELS</span><h2>Choisir avec les bonnes informations.</h2></div><p>Les établissements de santé n’ont pas tous les mêmes usages. Précisez votre contexte pour obtenir une réponse adaptée.</p></div><div class="editorial-grid"><article><span>01 / USAGE</span><h3>Décrivez la zone concernée</h3><p>Sols, surfaces hautes ou instruments : ce premier repère permet d’orienter la discussion vers la bonne famille.</p></article><article><span>02 / INFORMATION</span><h3>Demandez la documentation</h3><p>Contactez-nous pour connaître les références, présentations et documents disponibles à jour.</p></article><article><span>03 / ÉCHANGE</span><h3>Parlez de vos besoins</h3><p>Notre équipe échange avec les hôpitaux, cliniques et collectivités sur leurs demandes.</p></article></div></div></section><section class="section faq-section"><div class="container faq-layout"><div><span class="eyebrow">QUESTIONS FRÉQUENTES</span><h2>Les premières réponses.</h2><p>Pour les indications détaillées d’un produit, demandez toujours sa documentation spécifique.</p></div><div class="faq-list"><details><summary>Quels types de produits propose Azuré Pharm ?</summary><p>Trois familles sont présentées ici : détergents désinfectants pour sols et surfaces, pour surfaces hautes, et nettoyants pré-désinfectants des instruments.</p></details><details><summary>À quels établissements s’adressent ces gammes ?</summary><p>Azuré Pharm s’adresse notamment aux hôpitaux, aux cliniques et aux collectivités.</p></details><details><summary>Comment obtenir des informations sur une référence ?</summary><p>Utilisez le formulaire de contact ou appelez le 0660 456 457. Précisez la famille qui vous intéresse.</p></details></div></div></section><section class="contact-strip"><div class="container contact-strip-inner"><div><span class="eyebrow">INFORMATIONS PRODUITS</span><h2>Vous cherchez une solution adaptée ?</h2></div><a class="button button-inset button-strip" href="contact.html">Contacter Azuré Pharm <span aria-hidden="true">↗</span></a></div></section>
'''),
...
<section class="milestone-band"><div class="container milestone-grid"><div><strong>2021</strong><span>Début de l’activité</span></div><div><strong>03</strong><span>Familles de produits</span></div><div><strong>02</strong><span>Implantations en Algérie</span></div></div></section>
...
<section class="section company-purpose"><div class="container"><div class="section-heading split-heading"><div><span class="eyebrow">NOTRE RÔLE</span><h2>Une activité dédiée aux lieux de soins.</h2></div><p>Notre raison d’être est de proposer des solutions d’entretien et de pré-désinfection aux professionnels qui veillent chaque jour sur les patients.</p></div><div class="editorial-grid"><article><span>01 / MISSION</span><h3>Contribuer à l’hygiène</h3><p>Les produits Azuré Pharm sont destinés à accompagner les besoins d’entretien des établissements de santé.</p></article><article><span>02 / PROXIMITÉ</span><h3>Produire en Algérie</h3><p>La production est implantée à Ouled Moussa et le siège social à Dely Brahim, Alger.</p></article><article><span>03 / PERSPECTIVE</span><h3>Continuer à évoluer</h3><p>Des projets de recherche et développement accompagnent l’évolution des besoins du secteur.</p></article></div></div></section>
...
<section class="section"><div class="container"><div class="section-heading"><span class="eyebrow">DOMAINES D’ACTIVITÉ</span><h2>Au service des professionnels.</h2></div><div class="sector-grid"><div><span>01</span><h3>Hôpitaux</h3><p>Des espaces de soins où l’entretien des surfaces et des instruments fait partie des besoins quotidiens.</p></div><div><span>02</span><h3>Cliniques</h3><p>Des structures qui recherchent des familles de produits adaptées à leurs différents espaces.</p></div><div><span>03</span><h3>Collectivités</h3><p>Des lieux accueillant du public et des équipes, avec des besoins réguliers en hygiène.</p></div></div><div class="quality-note"><strong>Qualité & normes</strong><p>Les références exactes des certifications ISO n’ont pas été communiquées. Contactez notre équipe pour obtenir les informations et documents officiels à jour.</p></div></div></section><section class="contact-strip"><div class="container contact-strip-inner"><div><span class="eyebrow">ÉCHANGEONS</span><h2>Découvrir Azuré Pharm de plus près.</h2></div><a class="button button-inset button-strip" href="contact.html">Prendre contact ↗</a></div></section>
'''),
...
<section class="section"><div class="container rd-grid"><figure class="rd-photo"><img src="assets/azure-laboratory.png" alt="Illustration de la recherche et du développement Azuré Pharm"><figcaption>Visuel d’illustration</figcaption></figure><div><span class="eyebrow">NOTRE DÉMARCHE</span><h2>Observer, améliorer, avancer.</h2><p>La recherche et le développement occupent une place dans les projets d’Azuré Pharm. Notre ambition est de faire progresser nos solutions en restant attentifs aux usages et aux exigences des professionnels de santé.</p><p>Pour connaître nos produits et nos projets en cours, échangez directement avec notre équipe.</p><a class="button button-inset" href="contact.html">Prendre contact <span aria-hidden="true">↗</span></a></div></div></section>
<section class="section pale-section"><div class="container"><div class="section-heading split-heading"><div><span class="eyebrow">NOS AXES DE RÉFLEXION</span><h2>Une recherche liée au terrain.</h2></div><p>Les projets de recherche continus d’Azuré Pharm s’inscrivent dans la réalité des établissements de santé et dans l’évolution de leurs attentes.</p></div><div class="editorial-grid"><article><span>01 / USAGES</span><h3>Écouter les besoins</h3><p>Comprendre les différentes situations d’entretien des sols, des surfaces hautes et des instruments.</p></article><article><span>02 / GAMMES</span><h3>Faire évoluer les solutions</h3><p>Étudier les pistes d’amélioration qui peuvent répondre aux exigences des professionnels.</p></article><article><span>03 / DIALOGUE</span><h3>Rester en contact</h3><p>Échanger avec les acteurs du secteur pour relier les projets aux besoins concrets.</p></article></div></div></section>
<section class="section rd-focus"><div class="container rd-focus-grid"><div><span class="eyebrow">UNE DÉMARCHE CONTINUE</span><h2>Des questions utiles guident nos projets.</h2></div><div class="focus-list"><div><span>01</span><p>Quels usages demandent une réponse d’hygiène plus adaptée ?</p></div><div><span>02</span><p>Comment présenter les informations produits de manière plus claire ?</p></div><div><span>03</span><p>Quels besoins émergent dans les hôpitaux, cliniques et collectivités ?</p></div></div></div></section>
<section class="contact-strip"><div class="container contact-strip-inner"><div><span class="eyebrow">UN PROJET, UNE QUESTION ?</span><h2>Parlons de vos besoins.</h2></div><a class="button button-inset button-strip" href="contact.html">Écrire à Azuré Pharm ↗</a></div></section>
'''),
...
def product_page(name, family, summary, image, image_alt, facts, sections, source_note, related):
...
for filename, (title, description, body) in pages.items():
    body = (body
        ...
        .replace('Visuel illustratif du produit pour sols et surfaces', 'Bidon Azuré Pharm pour sols et surfaces')
        .replace('Visuel illustratif du produit pour surfaces hautes', 'Pulvérisateur Azuré Pharm pour surfaces hautes')
        .replace('Visuel illustratif du produit pour instruments', 'Bidon Azuré Pharm pour instruments médicaux')
